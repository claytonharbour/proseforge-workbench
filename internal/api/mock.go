...
type MockClient struct {
	// Stories
	ListStoriesFn                 func(ctx context.Context, params *gen.ListStoriesParams) (*StoryList, error)
	...
	ListStoriesWithReviewStatusFn func(ctx context.Context, params *gen.ListMyStoriesReviewStatusParams) (*StoriesWithReview, error)
	ListVersionsFn                func(ctx context.Context, storyID string, params *gen.ListStoryVersionsParams) (json.RawMessage, error)
	...
	WriteSectionFn   func(ctx context.Context, storyID, sectionID string, req UpdateSectionRequest) (json.RawMessage, error)
	ReorderSectionFn func(ctx context.Context, storyID, sectionID string, order int) (json.RawMessage, error)
	...
	// Narration
	StartNarrationFn    func(ctx context.Context, storyID string, voice string, force bool, emphasis *bool) error
	...
	RegenerateSectionFn func(ctx context.Context, storyID, sectionID string, force bool, voice string) error
	RetrySectionFn      func(ctx context.Context, storyID, sectionID string) error
	RebuildNarrationFn  func(ctx context.Context, storyID string, sectionAnnouncements bool, emphasis *bool) error
	...
	CancelSectionFn     func(ctx context.Context, storyID, sectionID string) error
	ListVoicesFn        func(ctx context.Context) (json.RawMessage, error)
	ListSegmentsFn      func(ctx context.Context, storyID, sectionID string) (json.RawMessage, error)
	RegenerateSegmentFn func(ctx context.Context, storyID, sectionID, segmentID, voice string) error
	...
	ListImagesFn         func(ctx context.Context, params *gen.ListImagesParams) (json.RawMessage, error)
	RegenerateImageFn    func(ctx context.Context, id string, req gen.HandlersRegenerateRequest) (json.RawMessage, error)
	ListStoryImagesFn    func(ctx context.Context, storyID string, includeSections bool) (json.RawMessage, error)
	...
	// Bundles
	ListBundlesFn                func(ctx context.Context) (json.RawMessage, error)
	GetBundleFn                  func(ctx context.Context, id string) (json.RawMessage, error)
	CreateBundleFn               func(ctx context.Context, name, intro string) (json.RawMessage, error)
	UpdateBundleFn               func(ctx context.Context, id, name, intro string) error
	DeleteBundleFn               func(ctx context.Context, id string) error
	AddBundleEntryFn             func(ctx context.Context, bundleID, storyID, transition string) (json.RawMessage, error)
	UpdateBundleEntryFn          func(ctx context.Context, bundleID, entryID, transition string) error
	RemoveBundleEntryFn          func(ctx context.Context, bundleID, entryID string) error
	ReorderBundleEntriesFn       func(ctx context.Context, bundleID string, entryIDs []string) error
	ExportBundleFn               func(ctx context.Context, id, format string) ([]byte, error)
	SetBundleCoverFn             func(ctx context.Context, bundleID, imageID string) error
	WhoAmIFn                     func(ctx context.Context) (json.RawMessage, error)
	ListFriendsFn                func(ctx context.Context, include string) (json.RawMessage, error)
	CountFriendsFn               func(ctx context.Context) (json.RawMessage, error)
	ListFriendCandidatesFn       func(ctx context.Context, search string) (json.RawMessage, error)
	RequestFriendFn              func(ctx context.Context, req CreateReviewerRequestReq) error
	RespondToFriendRequestFn     func(ctx context.Context, requestID string, req RespondToReviewerReq) error
	ListIncomingFriendRequestsFn func(ctx context.Context) (json.RawMessage, error)
	ListOutgoingFriendRequestsFn func(ctx context.Context) (json.RawMessage, error)
	RemoveFriendFn               func(ctx context.Context, friendID string) error
	ListSectionsFn               func(ctx context.Context, storyID string) (json.RawMessage, error)
}
...
func (m *MockClient) ListStories(ctx context.Context, params *gen.ListStoriesParams) (*StoryList, error) {
...
func (m *MockClient) ListStoriesWithReviewStatus(ctx context.Context, params *gen.ListMyStoriesReviewStatusParams) (*StoriesWithReview, error) {
...
func (m *MockClient) ListVersions(ctx context.Context, storyID string, params *gen.ListStoryVersionsParams) (json.RawMessage, error) {
...
func (m *MockClient) WriteSection(ctx context.Context, storyID, sectionID string, req UpdateSectionRequest) (json.RawMessage, error) {
	return m.WriteSectionFn(ctx, storyID, sectionID, req)
}

func (m *MockClient) ReorderSection(ctx context.Context, storyID, sectionID string, order int) (json.RawMessage, error) {
	return m.ReorderSectionFn(ctx, storyID, sectionID, order)
}
...
func (m *MockClient) StartNarration(ctx context.Context, storyID string, voice string, force bool, emphasis *bool) error {
	return m.StartNarrationFn(ctx, storyID, voice, force, emphasis)
}
...
func (m *MockClient) RegenerateSection(ctx context.Context, storyID, sectionID string, force bool, voice string) error {
	return m.RegenerateSectionFn(ctx, storyID, sectionID, force, voice)
}

func (m *MockClient) RetrySection(ctx context.Context, storyID, sectionID string) error {
	return m.RetrySectionFn(ctx, storyID, sectionID)
}

func (m *MockClient) RebuildNarration(ctx context.Context, storyID string, sectionAnnouncements bool, emphasis *bool) error {
	return m.RebuildNarrationFn(ctx, storyID, sectionAnnouncements, emphasis)
}
...
func (m *MockClient) CancelSection(ctx context.Context, storyID, sectionID string) error {
	return m.CancelSectionFn(ctx, storyID, sectionID)
}
...
func (m *MockClient) ListSegments(ctx context.Context, storyID, sectionID string) (json.RawMessage, error) {
	return m.ListSegmentsFn(ctx, storyID, sectionID)
}

func (m *MockClient) RegenerateSegment(ctx context.Context, storyID, sectionID, segmentID, voice string) error {
	return m.RegenerateSegmentFn(ctx, storyID, sectionID, segmentID, voice)
}
...
func (m *MockClient) ListImages(ctx context.Context, params *gen.ListImagesParams) (json.RawMessage, error) {
...
func (m *MockClient) ListStoryImages(ctx context.Context, storyID string, includeSections bool) (json.RawMessage, error) {
	return m.ListStoryImagesFn(ctx, storyID, includeSections)
}
...
func (m *MockClient) ListBundles(ctx context.Context) (json.RawMessage, error) {
	return m.ListBundlesFn(ctx)
}

func (m *MockClient) GetBundle(ctx context.Context, id string) (json.RawMessage, error) {
	return m.GetBundleFn(ctx, id)
}

func (m *MockClient) CreateBundle(ctx context.Context, name, intro string) (json.RawMessage, error) {
	return m.CreateBundleFn(ctx, name, intro)
}

func (m *MockClient) UpdateBundle(ctx context.Context, id, name, intro string) error {
	return m.UpdateBundleFn(ctx, id, name, intro)
}

func (m *MockClient) DeleteBundle(ctx context.Context, id string) error {
	return m.DeleteBundleFn(ctx, id)
}

func (m *MockClient) AddBundleEntry(ctx context.Context, bundleID, storyID, transition string) (json.RawMessage, error) {
	return m.AddBundleEntryFn(ctx, bundleID, storyID, transition)
}

func (m *MockClient) UpdateBundleEntry(ctx context.Context, bundleID, entryID, transition string) error {
	return m.UpdateBundleEntryFn(ctx, bundleID, entryID, transition)
}

func (m *MockClient) RemoveBundleEntry(ctx context.Context, bundleID, entryID string) error {
	return m.RemoveBundleEntryFn(ctx, bundleID, entryID)
}

func (m *MockClient) ReorderBundleEntries(ctx context.Context, bundleID string, entryIDs []string) error {
	return m.ReorderBundleEntriesFn(ctx, bundleID, entryIDs)
}

func (m *MockClient) ExportBundle(ctx context.Context, id, format string) ([]byte, error) {
	return m.ExportBundleFn(ctx, id, format)
}

func (m *MockClient) SetBundleCover(ctx context.Context, bundleID, imageID string) error {
	return m.SetBundleCoverFn(ctx, bundleID, imageID)
}

func (m *MockClient) WhoAmI(ctx context.Context) (json.RawMessage, error) {
	return m.WhoAmIFn(ctx)
}

func (m *MockClient) ListSections(ctx context.Context, storyID string) (json.RawMessage, error) {
	return m.ListSectionsFn(ctx, storyID)
}

func (m *MockClient) ListFriends(ctx context.Context, include string) (json.RawMessage, error) {
	return m.ListFriendsFn(ctx, include)
}
func (m *MockClient) CountFriends(ctx context.Context) (json.RawMessage, error) {
	return m.CountFriendsFn(ctx)
}
func (m *MockClient) ListFriendCandidates(ctx context.Context, search string) (json.RawMessage, error) {
	return m.ListFriendCandidatesFn(ctx, search)
}
func (m *MockClient) RequestFriend(ctx context.Context, req CreateReviewerRequestReq) error {
	return m.RequestFriendFn(ctx, req)
}
func (m *MockClient) RespondToFriendRequest(ctx context.Context, requestID string, req RespondToReviewerReq) error {
	return m.RespondToFriendRequestFn(ctx, requestID, req)
}
func (m *MockClient) ListIncomingFriendRequests(ctx context.Context) (json.RawMessage, error) {
	return m.ListIncomingFriendRequestsFn(ctx)
}
func (m *MockClient) ListOutgoingFriendRequests(ctx context.Context) (json.RawMessage, error) {
	return m.ListOutgoingFriendRequestsFn(ctx)
}
func (m *MockClient) RemoveFriend(ctx context.Context, friendID string) error {
	return m.RemoveFriendFn(ctx, friendID)
}
