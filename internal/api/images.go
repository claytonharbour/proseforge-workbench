...
func (c *Client) GenerateImage(ctx context.Context, req gen.HandlersGenerateImageRequest) (json.RawMessage, error) {
	resp, err := c.raw.GenerateImage(ctx, req)
	if err != nil {
...
func (c *Client) UploadImage(ctx context.Context, contentType string, body io.Reader) (json.RawMessage, error) {
	resp, err := c.raw.UploadImageWithBody(ctx, contentType, body)
	if err != nil {
...
func (c *Client) GetImage(ctx context.Context, id string) (json.RawMessage, error) {
	resp, err := c.raw.GetImage(ctx, id)
	if err != nil {
...
func (c *Client) ListImages(ctx context.Context, params *gen.ListImagesParams) (json.RawMessage, error) {
	resp, err := c.raw.ListImages(ctx, params)
	if err != nil {
...
func (c *Client) RegenerateImage(ctx context.Context, id string, req gen.HandlersRegenerateRequest) (json.RawMessage, error) {
	resp, err := c.raw.RegenerateImage(ctx, id, req)
	if err != nil {
...
func (c *Client) ListStoryImages(ctx context.Context, storyID string, includeSections bool) (json.RawMessage, error) {
	var params *gen.ListStoryImagesParams
	if includeSections {
		include := "sections"
		params = &gen.ListStoryImagesParams{Include: &include}
	}
	resp, err := c.raw.ListStoryImages(ctx, storyID, params)
	if err != nil {
...
func (c *Client) AttachImageToStory(ctx context.Context, storyID, imageID string, req gen.HandlersAddToStoryRequest) error {
	resp, err := c.raw.CreateStoryImage(ctx, storyID, imageID, req)
	if err != nil {
...
func (c *Client) SetStoryImageCover(ctx context.Context, storyID, imageID string) error {
	resp, err := c.raw.UpdateStoryImagesPrimary(ctx, storyID, imageID)
	if err != nil {
