...
// same rows.
// wirePartner: HandlersConversationResponse
...
// wirePartner: none — a client-side envelope; the server returns a bare array
type ConversationList struct {
	Conversations []Conversation `json:"conversations"`
}

func (c *Client) ListConversations(ctx context.Context) (*ConversationList, error) {
	resp, err := c.raw.ListConversations(ctx)
	if err != nil {
...
func (c *Client) CreateConversation(ctx context.Context, title string) (*Conversation, error) {
	body := gen.CreateConversationJSONRequestBody{}
	if title != "" {
		body.Title = &title
	}
	resp, err := c.raw.CreateConversation(ctx, body)
	if err != nil {
...
func (c *Client) AddConversationMember(ctx context.Context, id, principalID, capability string) error {
	...
	body := gen.CreateConversationGrantJSONRequestBody{
		PrincipalId: &principalID,
		Capability:  &capability,
	}
	resp, err := c.raw.CreateConversationGrant(ctx, id, body)
	if err != nil {
...
func (c *Client) RemoveConversationMember(ctx context.Context, id, principalID string) error {
	body := gen.DeleteConversationGrantJSONRequestBody{
		PrincipalId: &principalID,
	}
	resp, err := c.raw.DeleteConversationGrant(ctx, id, body)
	if err != nil {
...
func (c *Client) LeaveConversation(ctx context.Context, id string) error {
	resp, err := c.raw.DeleteMyConversationGrant(ctx, id)
	if err != nil {
