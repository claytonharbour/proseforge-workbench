...
func (c *Client) GetFeedbackReviews(ctx context.Context, storyID string) (*FeedbackReviewList, error) {
	resp, err := c.raw.ListStoryFeedbackReviews(ctx, storyID)
	if err != nil {
...
func (c *Client) GetFeedbackReview(ctx context.Context, storyID, reviewID string, include ...string) (*FeedbackReview, error) {
	params := &gen.GetStoryFeedbackReviewParams{}
	hasItems := false
	if len(include) > 0 {
		inc := include[0]
		params.Include = &inc
	...
	resp, err := c.raw.GetStoryFeedbackReview(ctx, storyID, reviewID, params)
	if err != nil {
...
func (c *Client) GetFeedbackReviewFull(ctx context.Context, storyID, reviewID string) (*FeedbackReviewWithItems, error) {
	items := "items"
	params := &gen.GetStoryFeedbackReviewParams{Include: &items}
...
func (c *Client) GetFeedbackDiff(ctx context.Context, storyID, reviewID string) (*ReviewDiffResponse, error) {
	resp, err := c.raw.GetStoryFeedbackReviewsDiff(ctx, storyID, reviewID)
	if err != nil {
...
func (c *Client) GetFeedbackSuggestions(ctx context.Context, storyID, reviewID string) (*FullFeedback, error) {
	resp, err := c.raw.ListStoryFeedbackReviewsSuggestions(ctx, storyID, reviewID)
	if err != nil {
...
func (c *Client) CreateFeedbackReview(ctx context.Context, storyID string, req StartAIReviewRequest) (*FeedbackReview, error) {
	resp, err := c.raw.CreateStoryFeedbackReview(ctx, storyID, gen.CreateStoryFeedbackReviewJSONRequestBody(req))
	if err != nil {
...
func (c *Client) AddFeedbackItem(ctx context.Context, storyID, reviewID string, req AddFeedbackItemRequest) error {
	resp, err := c.raw.CreateStoryFeedbackReviewsItem(ctx, storyID, reviewID, gen.CreateStoryFeedbackReviewsItemJSONRequestBody(req))
	if err != nil {
...
func (c *Client) SubmitReview(ctx context.Context, reviewID string) error {
	resp, err := c.raw.SubmitReview(ctx, reviewID)
	if err != nil {
...
func (c *Client) UpdateSectionContent(ctx context.Context, storyID, reviewID, sectionID, content string) error {
	req := gen.UpdateStoryFeedbackReviewsSectionsContentJSONRequestBody{
		Content: &content,
	}
	resp, err := c.raw.UpdateStoryFeedbackReviewsSectionsContent(ctx, storyID, reviewID, sectionID, req)
	if err != nil {
...
func (c *Client) IncorporateFeedback(ctx context.Context, storyID, reviewID string, req IncorporateRequest) error {
	resp, err := c.raw.IncorporateStoryFeedbackReview(ctx, storyID, reviewID, gen.IncorporateStoryFeedbackReviewJSONRequestBody(req))
	if err != nil {
