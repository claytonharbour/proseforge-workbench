...
func (c *Client) GetBundle(ctx context.Context, id string) (json.RawMessage, error) {
	resp, err := c.raw.GetBundleId(ctx, id)
	if err != nil {
...
func (c *Client) CreateBundle(ctx context.Context, name, intro string) (json.RawMessage, error) {
	body := gen.PostBundlesJSONRequestBody{Name: &name}
	if intro != "" {
		body.Intro = &intro
	}
	resp, err := c.raw.PostBundles(ctx, body)
	if err != nil {
...
func (c *Client) UpdateBundle(ctx context.Context, id, name, intro string) error {
	body := gen.PutBundleIdJSONRequestBody{}
	if name != "" {
		body.Name = &name
	}
	if intro != "" {
	...
	resp, err := c.raw.PutBundleId(ctx, id, body)
	if err != nil {
...
func (c *Client) DeleteBundle(ctx context.Context, id string) error {
	resp, err := c.raw.DeleteBundleId(ctx, id)
	if err != nil {
...
func (c *Client) AddBundleEntry(ctx context.Context, bundleID, storyID, transition string) (json.RawMessage, error) {
	body := gen.PostBundleIdEntriesJSONRequestBody{StoryId: &storyID}
	if transition != "" {
		body.Transition = &transition
	}
	resp, err := c.raw.PostBundleIdEntries(ctx, bundleID, body)
	if err != nil {
...
func (c *Client) UpdateBundleEntry(ctx context.Context, bundleID, entryID, transition string) error {
	resp, err := c.raw.PutBundleIdEntriesEntryId(ctx, bundleID, entryID,
		gen.PutBundleIdEntriesEntryIdJSONRequestBody{Transition: &transition})
	if err != nil {
...
func (c *Client) RemoveBundleEntry(ctx context.Context, bundleID, entryID string) error {
	resp, err := c.raw.DeleteBundleIdEntriesEntryId(ctx, bundleID, entryID)
	if err != nil {
...
func (c *Client) ReorderBundleEntries(ctx context.Context, bundleID string, entryIDs []string) error {
	resp, err := c.raw.PutBundleIdEntriesOrder(ctx, bundleID,
		gen.PutBundleIdEntriesOrderJSONRequestBody{EntryIds: &entryIDs})
	if err != nil {
...
func (c *Client) ExportBundle(ctx context.Context, id, format string) ([]byte, error) {
	...
	switch format {
	case "epub":
		resp, err = c.raw.GetBundleIdExportEpub(ctx, id)
	case "json":
		resp, err = c.raw.GetBundleIdExportJson(ctx, id)
	case "markdown":
		resp, err = c.raw.GetBundleIdExportMarkdown(ctx, id)
	case "pdf":
		resp, err = c.raw.GetBundleIdExportPdf(ctx, id)
	default:
...
func (c *Client) SetBundleCover(ctx context.Context, bundleID, imageID string) error {
	resp, err := c.raw.PutBundleIdCoverImageId(ctx, bundleID, imageID)
	if err != nil {
