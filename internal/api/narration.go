...
func (c *Client) RegenerateSection(ctx context.Context, storyID, sectionID string, force bool, voice string) error {
	...
	resp, err := c.raw.PostStoryIdNarrationSectionsSectionIdRegenerate(ctx, storyID, sectionID, body)
	if err != nil {
...
func (c *Client) RetrySection(ctx context.Context, storyID, sectionID string) error {
	resp, err := c.raw.PostStoryIdNarrationSectionsSectionIdRetry(ctx, storyID, sectionID)
	if err != nil {
...
func (c *Client) CancelSection(ctx context.Context, storyID, sectionID string) error {
	resp, err := c.raw.PostStoryIdNarrationSectionsSectionIdCancel(ctx, storyID, sectionID)
	if err != nil {
...
func (c *Client) ListSegments(ctx context.Context, storyID, sectionID string) (json.RawMessage, error) {
	resp, err := c.raw.GetStoryIdNarrationSectionsSectionIdSegments(ctx, storyID, sectionID)
	if err != nil {
...
func (c *Client) RegenerateSegment(ctx context.Context, storyID, sectionID, segmentID, voice string) error {
	...
	resp, err := c.raw.PostStoryIdNarrationSectionsSectionIdSegmentsSegmentIdRegenerate(ctx, storyID, sectionID, segmentID, body)
	if err != nil {
