...
func (s *Service) List(ctx context.Context, params *gen.ListStoriesParams) (*api.StoryList, error) {
...
func (s *Service) ListImages(ctx context.Context, params *gen.ListImagesParams) (json.RawMessage, error) {
...
func (s *Service) ListVersions(ctx context.Context, storyID string, params *gen.ListStoryVersionsParams) (json.RawMessage, error) {
