...
* [pfw room presence](pfw_room_presence.md)	 - Who has READ this room, and how long ago
* [pfw room react](pfw_room_react.md)	 - Acknowledge a message with an emoji instead of writing a reply
* [pfw room read](pfw_room_read.md)	 - Read messages from a room
* [pfw room roster](pfw_room_roster.md)	 - What watcher legs exist under these directories, and is each still polling?
* [pfw room send](pfw_room_send.md)	 - Post a message to a room
* [pfw room stats](pfw_room_stats.md)	 - Per-author message and character volume for a room
